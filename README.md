...
* **Résultat :** Au 5 avril, notre modèle **bat l'état de l'art sur la prévision OOS** (MAE globale $\approx 990$ vs $1200$, *Coverage* des intervalles de crédibilité à 95% maintenu à 97%). Nous disposons encore de pistes et d'une large marge d'amélioration, l'objectif étant de viser une MAE globale < 500 migrants. Résultats au 23 Avril: notre modèle bat toutes les métriques de la littérature, dont la MAPE avec 51,4% (contre 76% Welch&Raftery,2022)
